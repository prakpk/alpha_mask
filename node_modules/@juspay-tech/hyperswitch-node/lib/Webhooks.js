...
const {StripeError,HyperError, StripeSignatureVerificationError,HyperSignatureVerificationError} = require('./Error');
...
function parseEventDetails(encodedPayload, encodedHeader, expectedScheme) {
  ...
  if (!details || details.timestamp === -1) {
    throw new HyperSignatureVerificationError({
  ...
  if (!signatureFound) {
    throw new HyperSignatureVerificationError({
      message:
        ...
        ' Are you passing the raw request body you received from Hyper?' +
        ' https://www.npmjs.com/package/@juspay-tech/hyper-node',
      detail: {
        header,
        payload,
      },
