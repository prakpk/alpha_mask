  ...
  static generate(rawStripeError) {
    switch (rawStripeError.type) {
      ...
      case 'invalid_request_error':
        return new StripeInvalidRequestError(rawStripeError);
      case 'api_error':
        return new HyperAPIError(rawStripeError);
      case 'authentication_error':
        return new StripeAuthenticationError(rawStripeError);
      case 'rate_limit_error':
        return new StripeRateLimitError(rawStripeError);
...
class HyperAPIError extends StripeError {}
...
class HyperAuthenticationError extends StripeError {}
...
class HyperConnectionError extends StripeError {}
...
class HyperSignatureVerificationError extends StripeError {}
...
module.exports.HyperError = HyperError;
...
module.exports.HyperAPIError = HyperAPIError;

module.exports.StripeAuthenticationError = StripeAuthenticationError;
module.exports.HyperAuthenticationError = HyperAuthenticationError;
...
module.exports.HyperConnectionError = HyperConnectionError;

module.exports.StripeSignatureVerificationError = StripeSignatureVerificationError;
module.exports.HyperSignatureVerificationError = HyperSignatureVerificationError;
